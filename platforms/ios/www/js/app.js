...
/*
$scope.sugars=[["Xylitol","sugar alcohol","http://www.phoneflare.com"]]
  $scope.matches=true;
  $scope.safe=false;
  $scope.noscan=false;
...
$timeout(function(){
  $cordovaSocialSharing
    .share("a free app that helps identify sugar alcohols and artificial sweeteners", "SugarSweet: A Free Colitis/Crohn's app", "http://www.jarvisfilms.com/img/SugarSweetLogo.png", "http://www.jarvisfilms.com") // Share via native share sheet
